...
class _TranslateAppSampleState extends State<TranslateAppSample> {
  ...
  Future record(String messageIdAsName) async {
    ...
    await recorder.startRecorder(
        toFile: '$tempPath/translationPageInputSpeechAudio.wav', codec: Codec.pcm16WAV);
  }
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            maxLines: null, // Allows the TextField to expand to accommodate multiple lines of text.
                            expands: true,
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              iconSize: 50,
                              onPressed: () {
                                translateScreenController.playSelectedMessageAsAudio(translatedTextController.text, dropdownValue2);
                              },
                            ...
                            IconButton(
                              ...
                              onPressed: () async{
                                if(translatedTextController.text != ""){
                                  await Clipboard.setData(ClipboardData(text: translatedTextController.text));
                                }
